...
test('patreon', assert => {
    ...
    nock('https://api.patreon.com').get('/oauth2/api/current_user').reply(200, function(uri, body) {
        assert.ok(
    ...
    nock('https://api.patreon.com').get('/oauth2/api/current_user').replyWithError('Oh geeze')
